...
public class BookmarksDeleterTest {

	protected static Logger log = LoggerFactory.getLogger(BookmarksDeleterTest.class);

	@Test
	public void testBookmarksDeleter() throws Exception {
		WordprocessingMLPackage wordMLPackage = WordprocessingMLPackage
				.load(new File(System.getProperty("user.dir") + "/BookmarksDeleter.docx"));
		...
		// or save the docx...
		Docx4J.save(wordMLPackage, new java.io.File(System.getProperty("user.dir") + "/OUT_BookmarksDeleter.docx"));
	}
