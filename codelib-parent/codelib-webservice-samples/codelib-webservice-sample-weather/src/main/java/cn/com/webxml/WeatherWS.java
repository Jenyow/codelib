 ...
 * 
 */
@WebServiceClient(name = "WeatherWS", targetNamespace = "http://WebXml.com.cn/", wsdlLocation = "file:/E:/git/codelib/codelib-parent/codelib-webservice-samples/codelib-webservice-sample-cxf/codelib-webservice-sample-cxf-client/docs/wsdl/WeatherWS.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/E:/git/codelib/codelib-parent/codelib-webservice-samples/codelib-webservice-sample-cxf/codelib-webservice-sample-cxf-client/docs/wsdl/WeatherWS.wsdl");
