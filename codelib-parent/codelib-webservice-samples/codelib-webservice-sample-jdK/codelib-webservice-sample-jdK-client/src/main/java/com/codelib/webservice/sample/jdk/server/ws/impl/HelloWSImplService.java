 ...
 * 
 */
@WebServiceClient(name = "HelloWSImplService", targetNamespace = "http://impl.ws.server.jdk.sample.webservice.codelib.com/", wsdlLocation = "http://localhost:8080/codelib-webservice-sample-jdK-server/hellows?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWSIMPLSERVICE_QNAME = new QName("http://impl.ws.server.jdk.sample.webservice.codelib.com/", "HelloWSImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/codelib-webservice-sample-jdK-server/hellows?wsdl");
    ...
    public HelloWSImpl getHelloWSImplPort() {
        return super.getPort(new QName("http://impl.ws.server.jdk.sample.webservice.codelib.com/", "HelloWSImplPort"), HelloWSImpl.class);
    }
